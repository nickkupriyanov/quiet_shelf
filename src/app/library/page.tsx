...
export default function LibraryPage() {
  ...
  const { books, loading, error, refreshBooks } = useBooks(query);
  ...
  return (
    <div className="grid gap-5">
      <section className="rounded-[20px] border border-border-soft bg-card p-5">
        ...
        <div className="mt-6 grid gap-4 xl:grid-cols-[minmax(240px,1fr)_auto_260px] xl:items-end">
          <div>
            <label
